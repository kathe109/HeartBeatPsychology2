...
const BajaAutoestimaPage = () => {
  ...
  const imageUrl = "../assets/anime-mirror.jpg";  // Reemplaza esto con la ruta real de tu imagen

  return (
    <Container className='amor' maxWidth="md" style={{ padding: '20px',marginTop: '80px', maxWidth: '1000px', width: '1000px' }}>
      ...
      <Paper elevation={3} style={{ padding: '20px'}}>
        ...
        <Box style={{ marginBottom: '20px' }}>
          <Typography style={{maxWidth: '500px'}} paragraph>
        ...
        <CardMedia
          ...
          image={imageUrl}
          alt="baja"
          style={{ width: '100%', height: 'auto', marginBottom: '20px', maxWidth: '400px', marginTop: '-70px', position: 'relative', marginTop: '-70px', top: '-25px' }}
        />
        </Container>
